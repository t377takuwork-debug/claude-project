# cf_room WordPress media uploader via REST API (ASCII-only source for PS5.1)
...
#   { "site": "https://cf-room.com", "user": "WP-USER", "appPassword": "xxxx xxxx xxxx xxxx xxxx xxxx" }
...
if (-not (Test-Path $authFile)) {
    ...
    Write-Output '{ "site": "https://cf-room.com", "user": "YOUR-WP-USER", "appPassword": "xxxx xxxx xxxx xxxx xxxx xxxx" }'
    Write-Output "Get the app password in WP admin: Users > Profile > Application Passwords (name it e.g. cf-article)."
    exit 1
}
