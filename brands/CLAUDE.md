...
| MBTICODE Note記事生成 | `writing/writing_core.md` / `writing/writing_expressions.md` / `writing/writing_headlines.md` / `writing/writing_note_structure.md` / `mbticode_strategy.md` / `mbticode_tone.md` / `mbticode/persona_core.md` |
