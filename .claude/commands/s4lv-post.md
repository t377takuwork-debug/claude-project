...
3. `brands/s4lv/rules/feedback_s4lv_pro_writing_style.md` — X投稿文体OS（フック・本文・締め・禁止事項）
4. `brands/s4lv/rules/feedback_s4lv_pro_x_post.md` — 精度ルール・反響別の確定構造（96〜99点基準）・素材の使用可否
